...
@Component({
  selector: 'app-new-demande-personne',
  templateUrl: './new-demande-personne.component.html',
  styleUrls: ['./new-demande-personne.component.css']
})
export class NewDemandePersonneComponent implements OnInit {
  zones : Array<any> =[
    {name: 'ANP', value:'ANP'},
